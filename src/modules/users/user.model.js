...
import { identityKeyFields } from "../messaging/identityKey.schema.js";
...
const UserSchema = new mongoose.Schema(
    {
        ...
        // Hash of the currently-valid refresh token, never the token
        // itself. Cleared on logout or on detected token reuse.
        refreshTokenHash: {
            type: String,
            select: false,
        },
